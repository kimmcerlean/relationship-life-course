...
data <- read_dta("temp data/gsoep/gsoep_couples_imputed_wide_complete_tmp.dta")
...
## couple_work_ow_end: Couple-level work indicator (overwork split out, but not detailed)
## couple_hw_hrs_weekly_end:	Couple-level housework indicator, split by time spent 
