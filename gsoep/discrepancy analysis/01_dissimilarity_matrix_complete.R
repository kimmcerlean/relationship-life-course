...
save.image("G:/Other computers/My Laptop/Documents/Research Projects/Relationship Life Course (with LP)/discrepancy analysis exploration/gsoep-setupsequence-complete.RData")
