...
lab_t=c()
for (i in 1:10){
  lab_t[i]=paste("couple_hw_hrs_weekly_trunc",i, sep="")
}
...
write.xlsx(mantel.df.mi1, "results/GSOEP/gsoep_mantel_truncated_100p_mi1.xlsx")
...
write.xlsx(mantel.df.mi2, "results/GSOEP/gsoep_mantel_truncated_100p_mi2.xlsx")
...
write.xlsx(mantel.df.mi3, "results/GSOEP/gsoep_mantel_truncated_100p_mi3.xlsx")
...
write.xlsx(mantel.df.mi4, "results/GSOEP/gsoep_mantel_truncated_100p_mi4.xlsx")
...
write.xlsx(mantel.df.mi5, "results/GSOEP/gsoep_mantel_truncated_100p_mi5.xlsx")

save.image("created data/gsoep/gsoep_pooled_mantels.RData")
...
mantel_data <- read.csv("results/GSOEP/tables/pooled mantels/gsoep_mantel_truncated_100p_mis-combined.csv")
