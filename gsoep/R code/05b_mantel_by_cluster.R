...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# First need to get dissimilarity matrix for each cluster (using 9 cluster solution)
...
##### Cluster 1
dist.fam.c1 <- seqdist(mc9.fam1.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c1 <- seqdist(mc9.work.ow1.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c1 <- seqdist(mc9.hw.hrs1.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c1<-seqlength(mc9.fam1.seq, with.missing = FALSE)
...
##### Cluster 2
dist.fam.c2 <- seqdist(mc9.fam2.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c2 <- seqdist(mc9.work.ow2.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c2 <- seqdist(mc9.hw.hrs2.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c2<-seqlength(mc9.fam2.seq, with.missing = FALSE)
...
##### Cluster 3
dist.fam.c3 <- seqdist(mc9.fam3.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c3 <- seqdist(mc9.work.ow3.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c3 <- seqdist(mc9.hw.hrs3.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c3<-seqlength(mc9.fam3.seq, with.missing = FALSE)
...
##### Cluster 4
dist.fam.c4 <- seqdist(mc9.fam4.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c4 <- seqdist(mc9.work.ow4.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c4 <- seqdist(mc9.hw.hrs4.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)
  
  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c4<-seqlength(mc9.fam4.seq, with.missing = FALSE)
...
##### Cluster 5
dist.fam.c5 <- seqdist(mc9.fam5.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c5 <- seqdist(mc9.work.ow5.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c5 <- seqdist(mc9.hw.hrs5.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c5<-seqlength(mc9.fam5.seq, with.missing = FALSE)
...
##### Cluster 6
dist.fam.c6 <- seqdist(mc9.fam6.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c6 <- seqdist(mc9.work.ow6.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c6 <- seqdist(mc9.hw.hrs6.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c6<-seqlength(mc9.fam6.seq, with.missing = FALSE)
...
##### Cluster 7
dist.fam.c7 <- seqdist(mc9.fam7.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c7 <- seqdist(mc9.work.ow7.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c7 <- seqdist(mc9.hw.hrs7.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c7<-seqlength(mc9.fam7.seq, with.missing = FALSE)
...
##### Cluster 8
dist.fam.c8 <- seqdist(mc9.fam8.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c8 <- seqdist(mc9.work.ow8.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c8 <- seqdist(mc9.hw.hrs8.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)

  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c8<-seqlength(mc9.fam8.seq, with.missing = FALSE)
...
##### Cluster 9
dist.fam.c9 <- seqdist(mc9.fam9.seq, method="OM", indel=fam.miss.indel, 
                       sm= fam.miss.cost$sm, with.missing=TRUE)
dist.work.c9 <- seqdist(mc9.work.ow9.seq, method="OM", indel=work.miss.indel, 
                        sm= work.miss.cost$sm, with.missing=TRUE)
dist.hw.c9 <- seqdist(mc9.hw.hrs9.seq, method="OM", indel=hw.miss.indel, 
                      sm= hw.miss.cost$sm, with.missing=TRUE)
  
  ## Get cluster length (can just do for one domain bc will be same)
  seq.len.fam.c9<-seqlength(mc9.fam9.seq, with.missing = FALSE)
  
  c9.min.len <- matrix(NA,ncol=length(seq.len.fam.c9),nrow=length(seq.len.fam.c9))
  for (i in 1:length(seq.len.fam.c9)){
    for (j in 1:length(seq.len.fam.c9)){
      c9.min.len[i,j] <- min(c(seq.len.fam.c9[i],seq.len.fam.c9[j]))
    }
  }
  
  ## Normalize to min length
  dist.fam.c9.min<-dist.fam.c9 / c9.min.len
  dist.work.c9.min<-dist.work.c9 / c9.min.len
  dist.hw.c9.min<-dist.hw.c9 / c9.min.len
...
##### Cluster 9
mantel_work.hw.c9 = mantel(dist.work.c9.min, dist.hw.c9.min)
mantel_work.fam.c9 = mantel(dist.work.c9.min, dist.fam.c9.min)
mantel_hw.fam.c9 = mantel(dist.hw.c9.min, dist.fam.c9.min)

##### Total (get using OMs from step 00, validate match step 5?)
# confirmed this is true in PSID. this takes forever and slows this down, so not doing for rest of countries because don't need
...
cluster <- c('Cluster 1: work/hw', 'Cluster 1: work/fam',  'Cluster 1: hw/fam',
                ...
                'Cluster 9: work/hw', 'Cluster 9: work/fam',  'Cluster 9: hw/fam')
...
stats <- c(mantel_work.hw.c1$statistic, mantel_work.fam.c1$statistic, mantel_hw.fam.c1$statistic,
           ...
           mantel_work.hw.c9$statistic, mantel_work.fam.c9$statistic, mantel_hw.fam.c9$statistic)
...
sig <- c(mantel_work.hw.c1$signif, mantel_work.fam.c1$signif, mantel_hw.fam.c1$signif,
        ...
        mantel_work.hw.c9$signif, mantel_work.fam.c9$signif, mantel_hw.fam.c9$signif)
         
mantel_cluster <- data.frame(cluster, stats, sig)

write.xlsx(mantel_cluster, "results/GSOEP/gsoep_mantel_truncated_clusters.xlsx")
...
#write.xlsx(mantel.df, "results/GSOEP/gsoep_mantel_ci.xlsx")

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

save.image("created data/gsoep/GSOEP_truncated_mantel_by_cluster.RData")
