...
data <- read_dta("temp data/psid_couples_wide_truncated_tmp.dta")
...
# Save locally to make easier to use later - actually will do after next step
# save.image("G:/Other computers/My Laptop/Documents/Research Projects/Relationship Life Course (with LP)/discrepancy analysis exploration/psid-setupsequence-truncated.RData")
