...
pdf("results/PSID/PSID_RF100Plot_end_mc8_final_test.pdf",
  width=25,
  height=42)
...
pdf_convert("C:/Users/mcerl/Istituto Universitario Europeo/Pessin, Lea - 1. WeEqualize - Team Folder/Papers/Relationship Life Course/results/for paper/PSID_test.pdf",
           format = "png", dpi = 300, pages = 1,
            "C:/Users/mcerl/Istituto Universitario Europeo/Pessin, Lea - 1. WeEqualize - Team Folder/Papers/Relationship Life Course/results/for paper/PSID_test.png")
