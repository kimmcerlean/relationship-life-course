...
sumtable(desctable, digits = 4, fixed.digits = TRUE, numformat = NA, group = 'clusters', group.test = TRUE, 
         out='csv', file='results/PSID/tables/cluster_desctable_truncated.csv')
...
write.xlsx(state.time.family, "results/PSID/tables/psid_family_statedurs.xlsx")
...
write.xlsx(state.time.work, "results/PSID/tables/psid_work_statedurs.xlsx")
...
write.xlsx(state.time.hw, "results/PSID/tables/psid_hw_statedurs.xlsx")
...
sumtable(domain_table, digits = 4, numformat = NA, group = 'clusters', group.test = TRUE, 
         out='csv', file='results/PSID/tables/cluster_domain_info.csv')
...
# Save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
save.image("created data/psid_trunc_cluster_descriptives.RData")
