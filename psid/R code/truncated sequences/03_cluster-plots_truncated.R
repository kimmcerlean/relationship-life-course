...
#### State distribution
pdf("results/PSID/PSID_MCSA_SDPlot_truncated_mc5.pdf",
    width=15,
    height=28)
...
pdf("results/PSID/PSID_RF100Plot_start_truncated_mc5.pdf",
    width=15,
    height=42)
...
pdf("results/PSID/PSID_RF100Plot_end_truncated_mc5.pdf",
    width=15,
    height=42)
...
#### State distribution
pdf("results/PSID/PSID_MCSA_SDPlot_truncated_mc6.pdf",
    width=15,
    height=28)
...
#### Relative frequency: 100 K (start, domain: fam)
pdf("results/PSID/PSID_RF100Plot_start_truncated_mc6.pdf",
    width=15,
    height=42)
...
#### Relative frequency: 100 K (end, domain: fam)
pdf("results/PSID/PSID_RF100Plot_end_truncated_mc6.pdf",
    width=15,
    height=42)
...
#### State distribution
pdf("results/PSID/PSID_MCSA_SDPlot_truncated_mc7.pdf",
    width=15,
    height=28)
...
#### Relative frequency: 100 K, (start, domain: fam)
pdf("results/PSID/PSID_RF100Plot_start_truncated_mc7.pdf",
    width=15,
    height=42)
...
#### Relative frequency: 100 K, (end, domain: fam)
pdf("results/PSID/PSID_RF100Plot_end_truncated_mc7.pdf",
    width=15,
    height=42)
...
#### State distribution
pdf("results/PSID/PSID_MCSA_SDPlot_truncated_mc8.pdf",
    width=15,
    height=28)
...
#### Relative frequency: 100 K (start, domain: fam)
pdf("results/PSID/PSID_RF100Plot_start_truncated_mc8.pdf",
    width=15,
    height=42)
...
#### Relative frequency: 100 K (end, domain: fam)
pdf("results/PSID/PSID_RF100Plot_end_truncated_mc8.pdf",
    width=15,
    height=42)
