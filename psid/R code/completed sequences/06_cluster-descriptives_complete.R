...
sumtable(desctable, digits = 4, fixed.digits = TRUE, numformat = NA, group = 'clusters', group.test = TRUE, 
         out='csv', file='results/PSID/cluster_desctable.csv')
...
write.xlsx(state.time.family, "results/PSID/psid_family_statedurs.xlsx")
...
write.xlsx(state.time.work, "results/PSID/psid_work_statedurs.xlsx")
...
write.xlsx(state.time.hw, "results/PSID/psid_hw_statedurs.xlsx")
...
sumtable(domain_table, digits = 4, numformat = NA, group = 'clusters', group.test = TRUE, 
         out='csv', file='results/PSID/cluster_domain_info.csv')
...
sumtable(overall_metrics, digits = 4, fixed.digits = TRUE, numformat = NA, 
         out='csv', file='results/PSID/tables/Overall_Sequence_Metrics.csv')

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
save.image("created data/PSID_cluster_descriptives.RData")
