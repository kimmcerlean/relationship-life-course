...
tab total_hours imputed if jbstat==2, col // is this concerning? 20% of employed have 0 hours in imputed data.
...
// I need to go back to c and pull through transition year
// for now, merging on
