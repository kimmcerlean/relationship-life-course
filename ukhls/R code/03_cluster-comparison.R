...
mcdist.det.om <- seqdistmc(channels=list(unique.work.ow, unique.hw.hrs.alt, unique.fam), ## Seq states NOT om matrix
...
mcdist.simp.om <- seqdistmc(channels=list(unique.work, unique.hw, unique.fam), ## Seq states NOT om matrix
                            method="OM", indel=1, sm="CONSTANT") 
