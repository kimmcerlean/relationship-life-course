...
load("created data/ukhls/ukhls_setupsequence-complete.RData")
...
write.csv(relfreq6,("results/UKHLS/complete_cluster_freq_mc6.csv"))
...
write.csv(relfreq7,("results/UKHLS/complete_cluster_freq_mc7.csv"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~
# Temp save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~

save.image("created data/ukhls/typology-comparison-complete-prep.RData")

# also, export the data with the clusters attached to use for analysis in stata
write.dta(data, "created data/ukhls/UKHLS_clusters_complete_sequences.dta")
