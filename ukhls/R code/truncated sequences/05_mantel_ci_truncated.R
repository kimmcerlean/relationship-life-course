...
##### 100 permutations - better for CI (see F&A)
...
write.xlsx(mantel.df, "results/UKHLS/ukhls_mantel_ci_truncated_100perm.xlsx")
...
#write.xlsx(mantel.df, "results/UKHLS/ukhls_mantel_ci_truncated_1000perm.xlsx")

# Save again
#save.image("created data/ukhls/ukhls_mantel_by_cluster_ci_trunc.RData")
