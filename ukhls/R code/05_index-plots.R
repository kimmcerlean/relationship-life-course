...
pdf("results/UKHLS/UKHLS_MCSA_SDPlot.pdf",
    width=15,
    height=28)
...
pdf("results/UKHLS/UKHLS_MCSA_IndexPlot.pdf",
    width=15,
    height=28)
...
pdf("results/UKHLS/UKHLS_MCSA_RFPlot.pdf",
    width=15,
    height=28)
...
pdf("results/UKHLS/UKHLS_MCSA_RFPlot_500k.pdf",
    width=15,
    height=28)
...
# Plots speichern
ggsave(plot = ggjoint,
       "results/UKHLS_MCSA_Index.pdf",
       width = 16, height = 12) # , device = cairo_pdf

save.image("created data/UKHLS_index_plots.RData")
