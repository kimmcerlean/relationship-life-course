...
/*Setting directories based on ${comp}*/
	if ("${comp}"=="kim") {
		...
		global code    "G:/Other computers/My Laptop/Documents/GitHub/relationship-life-course/ukhls" // I am actually not sure if having the code on a shared directory will work. I am a bit worried about version control if the code can be updated in OneDrive but not yet pushed to github; I am worried about accidental changes. putting code into my own folder for now
	}
